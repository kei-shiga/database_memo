...
CREATE TABLE OrderDetails(
    OrderDetailID INT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    OrderID INTEGER,
    ProductID INTEGER,
    Quantity INTEGER,
...
-- 権限追加
GRANT ALL PRIVILEGES ON Categories TO nwuser;
GRANT ALL PRIVILEGES ON Customers TO nwuser;
GRANT ALL PRIVILEGES ON Employees TO nwuser;
GRANT ALL PRIVILEGES ON Shippers TO nwuser;
GRANT ALL PRIVILEGES ON Suppliers TO nwuser;
GRANT ALL PRIVILEGES ON Products TO nwuser;
GRANT ALL PRIVILEGES ON Orders TO nwuser;
GRANT ALL PRIVILEGES ON OrderDetails TO nwuser;
